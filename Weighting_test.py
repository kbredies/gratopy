...
for number_detectors in [50,100,200,400,800,1600]:
	...
	PS = projection_settings(img_shape=img.shape, angles= angles,  detector_width=detector_width, R=R,RE= RE, n_detectors=number_detectors,image_width=image_width,geometry="fan")
	delta_x=PS.delta_x
