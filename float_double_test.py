...
.fromarray(orj_img).resize(size=(new_h, new_w))
...
PS = projection_settings(img_shape=Wallnut.shape, angles = numberofangles,detector_width=Detectorwidth, R=FDD, RE=FOD, n_detectors=number_detectors,geometry="fan",data_type=data_type)
