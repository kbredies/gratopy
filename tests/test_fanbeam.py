...
TESTWALNUTSINOGRAM = Path(__file__).parent / "walnut_sinogram.png"
...
def test_geometric_orientation():
    ...
    Nx = 600
    img1 = np.zeros([Nx, Nx], dtype=np.float32)
...
def test_landweber():
    ...
    my_phantom = gratopy.phantom(queue, img_shape, dtype=np.float32)
