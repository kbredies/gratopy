...
//				  Entries are cos, sin, ofset and 1/max(|cos|,|sino|)
...
// Computes the backprojection projection in parallel beam geometry for a given image.
// the \my_variable_type_\order1\order2 suffix sets the kernel to the suitable
// precision, contiguity of the sinogram, contiguity of image.
// Input:
...
//			ofs:  Buffer containing geometric informations concerning the
//					projection-directions (angular information)
//				  Entries are cos, sin, ofset and 1/max(|cos|,|sin|)
//			Geometry_information:  Contains various geometric information
//					[delta_x,delta_xi,Nx,Ny,Ns,Na]
// Output:
//			values inside sino are altered to represent the computed Radon transform
