...
__kernel void equ_mul_add_\my_variable_type_\order1( __global real *rhs,
						     real a, __global real* x)
{
 size_t i = get_global_id(0);
  rhs[i]+=a*x[i];
}

__kernel void mul_add_add_\my_variable_type_\order1(__global real *rhs,
						    real a,
						    __global real* x,
						    __global real *y)
{
